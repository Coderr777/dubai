...
<span style="font-size:30px;cursor:pointer; color:white;" class="nav2"  >&#9776; Dashboard</span>
	...
	?>
  <a href="ad_guide_insert.php"><button type="button" class="btn btn-info" style="text-align: right;"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
</div>
	...
	<br/>
  <center>
    <h4 style="color:#68FF33";>Guide table </h4>
</center>
    <?php
 ...
 $query = "SELECT *FROM guide LIMIT " . $page_first_result . ',' . $results_per_page;  
 $result = mysqli_query($con, $query);  
   
for($page = 1; $page<= $number_of_page; $page++) {  
  echo '<a href = "ad_guide.php?page=' . $page . '">' . $page . ' </a>';  
}  
...
{ $i++;
  //  $row=mysqli_fetch_row($resgui);
    echo"<tr style='padding-top: 60px;'> 
              ...
              <td style='padding-top: 20px;'><img src='guide_img/$row[3]' width='100px' alt='image'>
              <td><a href='ad_guide_delete.php?uid=$row[0]'><button type='button' class='btn btn-danger'><i class='fa fa-trash'></i></button></a>
              <td><a href='ad_guide_update.php?uid=$row[0]'><button type='button' class='btn btn-warning'><i class='fa fa-pencil'></i></button></a>";
}   
