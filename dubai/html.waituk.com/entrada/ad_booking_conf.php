...
<body>
  ...
  <a href="ad_guide.php"class="icon-a"><i class="fa fa-tripadvisor icons"></i> &nbsp;&nbsp;Guide</a>
  <a href="ad_booking_pend.php"class="icon-a"><i class="fa fa-tripadvisor icons"></i> &nbsp;&nbsp;Booking Pending</a>
  <a href="ad_booking_conf.php"class="icon-a"><i class="fa fa-tripadvisor icons"></i> &nbsp;&nbsp;Confirm Booked</a>
</div>
<div id="main">
...
<a href="ad_activities_insert.php"><button type="button" class="btn btn-info" style="text-align: right;"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
	...
	<br/>
  <center>
    <h4 style="color:#68FF33";>Booking table </h4>
</center>
    <?php
 ...
 for($page = 1; $page<= $number_of_page; $page++) {  
  echo '<a href = "ad_booking_conf.php?page=' . $page . '">' . $page . ' </a>';  
}  

$selact="select * from booking";
