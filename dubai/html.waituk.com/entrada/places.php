            ...
            >
              <ul>
                ...
                >
                  ...
                  <img
                    alt="image description"
                    src="img/banner/img-33.jpg"
                    data-lazyload="img/banner/img-34.jpg"
          ...
          <section class="content-block article-boxed">
            <div class="container">
              <header class="content-heading">
                <h2 class="main-heading">TOP Places</h2>
                <span class="main-subtitle"
                  >Our collection of the most popular and most visited Places.</span
                >
              ...
              <div class="row same-height">
                ...
                <div class="col-md-6 text-block height wow slideInRight">
                  <div class="centered">
                    ...
                    <a href="place_desc.php?id='. $row[0] .'" class="btn btn-primary btn-lg">explore</a>
                  </div>
                </div>
              </div>
              <br>';
