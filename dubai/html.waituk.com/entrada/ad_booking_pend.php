...
<a href="ad_activities_insert.php"><button type="button" class="btn btn-info" style="text-align: right;"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
	...
	<br/>
  <center>
    <h4 style="color:#68FF33";>Booking Pending table </h4>
</center>
    <?php
 ...
 $query = "select * from booking_pend";  
 ...
 $query = "SELECT *FROM hotel LIMIT " . $page_first_result . ',' . $results_per_page;  
 $result = mysqli_query($con, $query);
 for($page = 1; $page<= $number_of_page; $page++) {  
  echo '<a href = "ad_booking_pend.php?page=' . $page . '">' . $page . ' </a>';  
}  

$selact="select * from booking_pend";
$resact=mysqli_query($con,$selact);
$n=mysqli_num_rows($resact);
echo'<table class="table table-striped table-hover">';
echo "<h1>";
echo"<th style='padding-top: 20px;'> Booking id
     <th style='padding-top: 20px;'> Package id
     ...
     <th style='padding-top: 20px;'> members
     <th style='padding-top: 20px;'> price
     <th style='padding-top: 20px;'> Country
     <th style='padding-top: 20px;'> Booked at
     <th>
     <th> 
";
for ($i=1; $i <=$n; $i++) 
{ 
    ...
    echo"<tr style='padding-top: 60px;'> 
              ...
              <td style='padding-top: 20px;'>$row[9]
              <td><a href='ad_book_conf.php?uid=$row[0]'><button type='button' class='btn btn-success'><i class='fa fa-check'></i></button></a>
              <td><a href='ad_book_cancel.php?uid=$row[0]'><button type='button' class='btn btn-danger'><i class='fa fa-times'></i></button></a>";
}   
