...
<body>
  ...
  <a href="ad_guide.php"class="icon-a"><i class="fa-thin fa-square-person-confined"></i> &nbsp;&nbsp;Guides</a>
</div>
<div id="main">
...
<span style="font-size:30px;cursor:pointer; color:white;" class="nav2"  >&#9776; Dashboard</span>
	...
	?>
  <a href="ad_user_insert.php"><button type="button" class="btn btn-info" style="text-align: right;"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
</div>
	...
	<br/>
  <center>
    <h1 style="color:#68FF33";>Users table </h1>
</center>
    <?php
 ...
 $query = "SELECT *FROM usertable LIMIT " . $page_first_result . ',' . $results_per_page;  
 $result = mysqli_query($con, $query);  
...
echo"<th style='padding-top: 20px;'>   #
     ...
     <th style='padding-top: 20px;'> Mobile no. 
     <th style='padding-top: 20px;'> Otp code 
     <th style='padding-top: 20px;'> Status 
     <th> 
";
//for ($i=1; $i <=$n; $i++) 
$i=0;
...
//    $row=mysqli_fetch_row($resuser);
    echo"<tr style='padding-top: 60px;'> 
              ...
              <td><a href='user_delete.php?uid=$row[0]'><button type='button' class='btn btn-danger'><i class='fa fa-trash'></i></button></a>";
}   

echo "</table>";
for($page = 1; $page<= $number_of_page; $page++) {  
  echo '<a href = "ad_users.php?page=' . $page . '">' . $page . ' </a>';  
}  
